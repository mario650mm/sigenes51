...
<div class="row">
	<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
			<div class="form-group">
				<!-- <label class="label-control col-lg-4 col-sm-4 col-md-4 col-xs-4">Semestre:</label> -->
				<div class="row col-lg-6 col-sm-6 col-md-6 col-xs-6">
					<div class="row">
				...
				<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
					<div class="row">
						<input type="radio" id="subjectmatter" name="study" ng-model="subjectmatter.iscomun_deep"  ng-click="changeComun()"/><label class="label-control">&nbsp;&nbsp;&nbsp;Es de tronco común</label>
					</div>
					<div class="row">
						<input type="radio" id="deepingarea" name="study" ng-model="subjectmatter.isdeepending" ng-init="subjectmatter.isdeepending=false" ng-click="change()"/><label class="label-control">&nbsp;&nbsp;&nbsp;Es de profundización</label> 
					</div>
					<div class="row">
						<input type="radio" id="technique" name="study" ng-model="subjectmatter.istechnique"ng-init="subjectmatter.istechnique=false" ng-click="changeComun()"/><label class="label-control">&nbsp;&nbsp;&nbsp;Es Carrera tecnica</label>
					</div>
				</div>
			</div>
		</div>
