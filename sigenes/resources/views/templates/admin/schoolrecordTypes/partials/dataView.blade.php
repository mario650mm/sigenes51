					...
					<td>
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
								<a ><span class="glyphicon glyphicon-edit" data-toggle="tooltip" title="Editar constancia"></span></a>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
								<a data-ng-click="delete(entity)"><span class="glyphicon glyphicon-trash" data-toggle="tooltip" title="Eliminar constancia"></span></a>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
								<a data-ng-click="showView(entity)"><span class="glyphicon glyphicon-check" data-toggle="tooltip" title="Ver constancia"></span></a>
							</div>
						</div>
					</td>
				</tr>	
